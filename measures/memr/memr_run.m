function metadata = memr_run(params, save_dir, metadata, tdt, ear_cal, callbacks)
% MEMR_RUN  Run MEMR acquisition.
%
% Inputs:
...
switch lower(params.stim_type)
    ...
    %% ============================================================
        ...
        %% --- Generate stimulus ---
        [stim_out, stim_info] = memr_make_stimulus(params);
        ...
        stim_info.att_ch1 = att_ch1; 
        stim_info.att_ch2 = att_ch2; 
        ...
        for trial_idx = 1:params.trials
            ...
            if trial_idx >= 2   % need at least 2 trials for artifact rejection stats
                [result, done] = memr_online_analysis(...
